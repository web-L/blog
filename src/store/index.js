...
export default new Vuex.Store({
    state: {
        ...
        slideNavState: false,
        slideTips: [
            '没有人不爱惜他的生命，但很少人珍惜他时间。',
            '高质量的代码是对程序最好的注释。',
            '能摆平那些有心智缺陷的人，比如那些资深的策划者。',
            '真正的程序员喜欢兼卖爆米花，他们利用CPU散发的热量做爆米花，可以根据米花 爆裂的速度听出正在运行什么程序。',
            '看程序包括别人的程序和看自己的程序，学习和思考非常 重要。',
            '一个好的程序员在一天的工作时间，花2/3的时间看程序，花1/6的时间写程序，还有1/6时间来陪女友聊天。',
            '陪女友、家人、别变成工作狂，要生活和工作一样精彩。',
            '布施、持戒、精进、禅定、智慧。',
            '当你凝望深渊，深渊也在看着你。',
            '你悠闲地看着屏幕的这一刻，对，就是你下正有所思索的此时此刻。'
        ]
    },
    mutations: {
